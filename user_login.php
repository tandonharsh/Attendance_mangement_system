...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"]== "POST" && isset($_POST['login'])){
        ...
        $q1="SELECT * FROM `$tableName` WHERE `user_name`='$id' AND `password`='$pass';";
    ...
    if($showAlert){
        ...
        <strong>Invalid Credentials!<h5>😥</h5></strong> <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
        </div>";
         $showAlert=false;
        }
            ...
            <div class="card mt-5 bg-dark text-white">
                ...
                <div class="cardbody mx-4 my-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" required id="user_id" aria-describedby="emailHelp"
                            name="id">
